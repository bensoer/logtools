...
function parseCollection(Array $collection){
    ...
    $matches4 = array();
    $timestamp = "";
    if(preg_match("/(\\d{2}\\/\\d{2}-\\d{2}:\\d{2}:\\d{2}\\.\\d*)\\s/", $fullEntryLowerd, $matches4)){
        //var_dump($matches4);
...
*/
    ...
    return Array(
        ...
        'packetid' => "",
        'iplength' => 0, //int
        'datagramlength' => 0 //int
    );
}



$directory = "/mnt/DATA/8006FP/Documents/network1/data/fw.var.log.tar/snort/eth1/alerts/unzipped-alerts";

$database=  new medoo([
    'database_type' => 'mysql',
    'database_name' => 'net1eth1',
    'server' => 'localhost',
    'username' => 'root',
    'password' => 'password',
    'charset' => 'utf-8'
